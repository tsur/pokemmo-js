...
class Main {
	...
	static public var onScreenCanvas:CanvasElement;
	static public var onScreenCtx:CanvasRenderingContext2D;
	
	static public var tmpCanvas:CanvasElement;
	static public var tmpCtx:CanvasRenderingContext2D;
	
	static public var mapCacheCanvas:CanvasElement;
	...
	static public function initGame(canvas_:CanvasElement, container_:DivElement):Void {
		...
		jq(window).resize(function(){
			...
			if(Game.curGame != null && GameMap.cur != null) Map.cur.cacheMap = null;
			Renderer.render();
		}).resize();
