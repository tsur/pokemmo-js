...
class GameMap {
	...
	public var warps:Map<String,MapWarp>;
	public var points:Map<String,Location>;
	
	public var instances:Map<String,MapInstance>;
	...
	public function new(id:String) {
		...
		data = Node.parse(Node.fs.readFileSync('public/assets/resources/maps/' + id + '.json', options));
